export default function () {
  return (
    <>
      <h2 className="list-disc">Rules</h2>
      <ul>
        <li>
        ...
        <li>
          User B sees the lobby and joins the battle by depositing 10 cards into
          the lobby
        </li>
        ...
        <li>
          For instance, user A might put 2 strong cards on line x, 2 weak cards
          on line y, and one super strong card on line z
        </li>
        <li>
        ...
        <li>
          When attacking all attack attributes of the attacking side's cards on
          the lane are summed
        </li>
        <li>
